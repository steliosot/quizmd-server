...
gcloud run deploy quizmd-server \
  ...
  --max-instances 1 \
  --timeout 3600 \
  --set-env-vars ROOM_MAX_PLAYERS=16,QUESTION_TIMEOUT_SECONDS=30,ROOM_TTL_MINUTES=30,HOST_REJOIN_SECONDS=60,START_COUNTDOWN_SECONDS=5,COLLABORATE_MAX_RETRIES=3,COLLABORATE_DISCUSSION_SECONDS=40
```
